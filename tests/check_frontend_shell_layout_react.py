...
def main() -> None:
    ...
    require("frontend/react/src/components/Sidebar.jsx", 'from "lucide-react"', "Sidebar uses the maintained Lucide icon library")
    require("frontend/react/src/components/Sidebar.jsx", "const Icon = icons[type]", "Sidebar icon families share one component map")
