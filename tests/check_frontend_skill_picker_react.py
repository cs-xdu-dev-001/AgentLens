...
def main() -> None:
    ...
    for needle, label in [
        ...
        ("aria-controls={historySearchOpen", "textarea history controls"),
        ('? "composer-history-listbox"', "textarea history listbox"),
        ('? "workspace-mention-listbox"', "textarea mention listbox"),
        ('? "composer-slash-listbox"', "textarea slash listbox"),
        ("aria-expanded={historySearchOpen || mentionOpen || pickerOpen}", "textarea picker expanded state"),
