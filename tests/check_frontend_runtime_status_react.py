...
def main() -> None:
    ...
    require("frontend/react/src/components/Sidebar.jsx", "setChecking", "runtime probe state")
    require("frontend/react/src/components/Sidebar.jsx", "requestRef", "stale runtime probe guard")
    require("frontend/react/src/components/Sidebar.jsx", "setInterval", "runtime heartbeat polling")
    require("frontend/react/src/components/Sidebar.jsx", "clearInterval", "runtime heartbeat cleanup")
    require("frontend/react/src/components/Sidebar.jsx", 'addEventListener("online"', "browser reconnect listener")
    require("frontend/react/src/components/Sidebar.jsx", 'addEventListener("offline"', "browser disconnect listener")
    require("frontend/react/src/components/Sidebar.jsx", 'addEventListener("visibilitychange"', "background probe throttling")
    require("frontend/react/src/components/Sidebar.jsx", "runtime-retry-button", "runtime retry control")
    ...
    require("frontend/refinement.css", ".runtime-card-offline strong", "offline runtime status styling")
    require("frontend/refinement.css", ".runtime-retry-button", "runtime retry styling")
