...
CREATE INDEX IF NOT EXISTS idx_cli_device_authorization_expires ON cli_device_authorization(expires_at);
...
CREATE TABLE IF NOT EXISTS cli_device_authorization (
  ...
  KEY idx_cli_device_authorization_expires (expires_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
