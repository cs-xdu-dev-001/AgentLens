...
| `KNOWFLOW_AGENT_ENGINE` | Agent execution engine; `langgraph` is the default, while `current` is retained for explicit rollback and historical-run compatibility | `langgraph` |
